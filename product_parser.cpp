...
{
    return new Book(categoryID(), prodName_, price_, qty_, isbn_, author_); // return a new Book to the parser for products
...
{
    return new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_); // return a new Clothing to the parser for products
...
{
    return new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_); // return a new Movie to the parser for products
